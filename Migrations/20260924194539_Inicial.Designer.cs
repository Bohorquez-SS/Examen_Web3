...
namespace VeterinariaApp.Migrations
{
    ...
    [Migration("20260924194539_Inicial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VeterinariaApp.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("VeterinariaApp.Models.ServicioVeterinario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("VeterinariaApp.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("VeterinariaApp.Models.Cita", b =>
                {
                    ...
                    b.HasOne("VeterinariaApp.Models.ServicioVeterinario", "ServicioVeterinario")
                        .WithMany("Citas")
            ...
            modelBuilder.Entity("VeterinariaApp.Models.Mascota", b =>
                {
                    b.HasOne("VeterinariaApp.Models.ApplicationUser", "Usuario")
                        .WithMany("Mascotas")
